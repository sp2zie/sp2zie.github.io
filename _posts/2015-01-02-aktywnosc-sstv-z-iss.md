...
Jako sympatycy ISS przyłączyliśmy się do tej akcji, choć tym razem indywidulanie. Wynikiem działań Roberta SQ2WHH był odbiór kilku obrazów w dobrej jakości, które można podziwiać poniżej. Na uwagę zasługuje używany doraźnie sprzęt stacji odbiorczej, gdzie wykorzystano antenę Windom FD-4 i radiotelefon Yaesu FT-2400. Zatem dla łączności kosmicznych nie są konieczne wielomilionowe nakłady ;-)

Oficjalnie odebrane obrazy z pokładu ISS można podziwiać i raportować na stronie: [ariss-usa.org](https://ariss-usa.org/ARISS_SSTV/), zaś w przyszłości mają się pojawić kolejne transmisje nowych serii obrazów ze stacji RS0ISS.

{% include image-gallery.html folder="assets/images/phocagallery/20141218-sstv-z-iss/thumbs" %}
