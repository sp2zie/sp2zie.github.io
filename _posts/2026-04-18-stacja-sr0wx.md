---
layout: page
title: Budowa stacji systemu SR0WX - v2023
date: 2026-04-18
...
Stacja ta, podaje tekstem bierzącą oraz prognozowaną pogodę oraz inne wybrane warunki dla naszego regionu na częstotliwości 144.950MHz (FM). Komunikaty podawane są co 15 minut w następującej kolejności:

- XX:00 - Prognoza meteorologiczna, ostrzerzenia meteo i hydrologiczne, warunki propagacyjne, poziom promieniowania, pogoda kosmiczna, wschód i zachód słońca
- XX:15 - Prognoza morska dla Baltyku z https://baltyk.imgw.pl/
- XX:30 - Prognoza meteorologiczna, ostrzerzenia meteo i hydrologiczne, warunki propagacyjne, poziom promieniowania, pogoda kosmiczna, wschód i zachód słońca
- XX:45 - Harmonogram stacji
